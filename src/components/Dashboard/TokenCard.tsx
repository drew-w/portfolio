    ...
    return (
      ...
      >
        ...
        >
          ...
          <Stack h='full' spacing='20px' direction='column' w='full' py='10px'>
            <Stack direction='row' spacing='2px' w='full'>
              {top4Formatted?.order.map((tokenKey: string | TokenKeys[any]) => {
                ...
                return (
                  <Box
                    ...
                    h='20px'
                    bg={
                      project ? project.uiConfig.primaryColor : 'text-primary'
                    }
                    w={`${percent}%`}
                  />
                )
            ...
            <Stack spacing='9px'>
              {top4Formatted?.order.map((tokenKey: TokenKeys[any] | string) => {
                const project = projects.find(
                  project => project.token.symbol === tokenKey
                )
                //@ts-ignore
                  ...
                  >
                    <Stack direction='row' align='center' fontSize='15px'>
                      <Box
                        ...
                        h='12px'
                        borderRadius='full'
                        bg={project?.uiConfig.primaryColor || 'text-primary'}
                      />
